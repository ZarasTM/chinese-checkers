...
public class CCBoard2P extends GameBuilder {
    ...
    public void setWinningZones() {
        ...
        // setting winning field for Player 2 on starting field for player 1
        for(int i = 5; i <= 8; i++){
            for(int j = 1; j <= 4; j++){
                if(j == 3){
        ...
        // setting winning field for Player 1 on starting field for player 2
